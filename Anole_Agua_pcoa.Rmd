...
names(Sample_color_pal) <- c("Aguadilla_forest","Aguadilla_urban")
Sample_color_pal
```
...
# Need to rerun these chunks when you switch between beta diversity methods
