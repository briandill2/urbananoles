...
Title <- c("Anole_Fecal","Anole_Fecal","Anole_Fecal","Anole_Fecal","Anole_Fecal","Anole_Fecal","Anole_Fecal","Anole_Fecal","Anole_Fecal","Anole_Fecal","Anole_Fecal","Anole_Fecal","Anole_Fecal","Anole_Fecal","Anole_Fecal","Anole_Fecal","Anole_Fecal","Anole_Fecal","Anole_Fecal")
loc_name <- c("Mayaguez_forest","Mayaguez_forest","Mayaguez_forest","Mayaguez_forest","Mayaguez_forest","Mayaguez_forest","Mayaguez_forest","Mayaguez_forest","Mayaguez_forest","Mayaguez_urban","Mayaguez_urban","Mayaguez_urban","Mayaguez_urban","Mayaguez_urban","Mayaguez_urban","Mayaguez_urban","Mayaguez_urban","Mayaguez_urban","Mayaguez_urban")
env_biome <- c("Natural","Natural","Natural","Natural","Natural","Natural","Natural","Natural","Natural","Urban","Urban","Urban","Urban","Urban","Urban","Urban","Urban","Urban","Urban")
sample <- c("AF104", "AF105", "AF106", "AF107", "AF108", "AF109", "AF110", "AF111", "AF112", "AF113", "AF114", "AF115", "AF116", "AF117", "AF118", "AF119", "AF120", "AF121", "AF122")
Mayaguez <- data.frame(title = Title, Loc_name = loc_name, Env_biome = env_biome, Sample = sample)
rownames(Mayaguez) <- samples.out

# Make the actual phyloseq object!

ps <- phyloseq(otu_table(seqtab.nochim, taxa_are_rows = FALSE), sample_data(Mayaguez), tax_table(taxa))
Mayaguez
